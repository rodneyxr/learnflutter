...
This app requires an environment variable set for the openweathermap.org API Key. You can specify this by adding the following to your flutter args.
```bash
--dart-define=APIKEY=2071fdd93c4df48df79df960ad578c7a
```
